...
const createRntRequestIntDB = async (userId, payload, isTentent) => {
...
const getRentalRqt = async (userId, isTentent) => {
...
const getRentRqtById = async (userId, rentId, isOwner) => {
    const userfind = await prisma.users.findUniqueOrThrow({
        where: {
            id: userId
        }
...
//# sourceMappingURL=rentreq.service.js.map